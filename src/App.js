...
const Search=()=>{
  ...
  <div className=" back">
    <div className='container'>
      ...
      <div className='row ' style={{alignItems:"center",justifyContent:"center",height:"100vh",marginTop:-200}}>
...
{stext1?<button type="button" onClick={()=>Search()}  class="btn btn-info m-2">Search</button>:<div></div>}
      ...
      <div className='row' style={{alignItems:"center",justifyContent:"center",marginTop:-200}}>
